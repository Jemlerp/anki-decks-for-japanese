...
namespace kanjiDeckForLiudger
{
    ...
    public static class Arbijd
    {
        ...
        public static List<AnkiKanjiEntry> GetAnkisFromTxt(string location)
        {
            List<AnkiKanjiEntry> toReturn = new List<AnkiKanjiEntry>();
            ...
            foreach (string line in File.ReadAllLines(location))
            {
                ...
                if (allKanji.Contains(erKanji))
                {
                    AnkiKanjiEntry entry = new AnkiKanjiEntry();
                    entry.AnkiLine = line;
                    entry.Kanji = erKanji;
                    toReturn.Add(entry);
                }
